...
import com.ipay.api.common.internal.util.XmlUtils;
...
public class XmlConverter implements Converter {
    ...
    private <T> T getModelFromXML(final Element element, Class<T> clazz) throws IpayApiException {
        if (element == null)
            return null;
                    ...
                    for (Element itemE : itemEs) {
                        ...
                        if (String.class.isAssignableFrom(subType)) {
                            ...
                            DateFormat format = new SimpleDateFormat(
                                IpayConstants.DATE_TIME_FORMAT);
                            try {
    ...
    private String getSign(String body) {
        ...
        String signNodeName = "<" + IpayConstants.SIGN + ">";
        String signEndNodeName = "</" + IpayConstants.SIGN + ">";
     ...
     * @return
     */
    private ResponseParseItem getXMLSignSourceData(IpayRequest<?> request, String body) {
    ...
    private ResponseParseItem parseXMLSignSourceData(String body, String rootNode,
        ...
        String xmlStartNode = "<" + IpayConstants.RESPONSE_XML_ENCRYPT_NODE_NAME + ">";
        String xmlEndNode = "</" + IpayConstants.RESPONSE_XML_ENCRYPT_NODE_NAME + ">";
