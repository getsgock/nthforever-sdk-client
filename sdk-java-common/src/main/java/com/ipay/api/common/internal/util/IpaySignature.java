...
import com.ipay.api.common.internal.util.codec.Base64;

/**
 * 
 * @author runzhi
 */
public class IpaySignature {
    ...
    public static String rsaSign(String content, String privateKey, String charset,
                                 String signType) throws IpayApiException {

        if (IpayConstants.SIGN_TYPE_RSA.equals(signType)) {

            return rsaSign(content, privateKey, charset);
        } else if (IpayConstants.SIGN_TYPE_RSA2.equals(signType)) {

            return rsa256Sign(content, privateKey, charset);
        } else {

            throw new IpayApiException("Sign Type is Not Support : signType=" + signType);
        }
    ...
    public static String rsa256Sign(String content, String privateKey,
                                    String charset) throws IpayApiException {

        try {
            PrivateKey priKey = getPrivateKeyFromPKCS8(IpayConstants.SIGN_TYPE_RSA,
                new ByteArrayInputStream(privateKey.getBytes()));

            java.security.Signature signature = java.security.Signature
                .getInstance(IpayConstants.SIGN_SHA256RSA_ALGORITHMS);
            ...
            throw new IpayApiException("RSAcontent = " + content + "; charset = " + charset, e);
        }
    ...
    public static String rsaSign(String content, String privateKey,
        ...
        try {
            ...
            java.security.Signature signature = java.security.Signature
                .getInstance(IpayConstants.SIGN_ALGORITHMS);
            ...
            throw new IpayApiException("RSA私钥格式不正确，请检查是否正确配置了PKCS8格式的私钥", ie);
        } catch (Exception e) {
            throw new IpayApiException("RSAcontent = " + content + "; charset = " + charset, e);
        }
    }
    ...
    public static boolean rsaCheckV1(Map<String, String> params, String publicKey,
            String charset,String signType) throws IpayApiException {
		String sign = params.get("sign");
		String content = getSignCheckContentV1(params);
     ...
     * @throws IpayApiException 
     */
    public static String checkSignAndDecrypt(Map<String, String> params, String ipayPublicKey,
                                             String cusPrivateKey, boolean isCheckSign,
                                             boolean isDecrypt) throws IpayApiException {
        String charset = params.get("charset");
        String bizContent = params.get("biz_content");
        if (isCheckSign) {
            if (!rsaCheckV2(params, ipayPublicKey, charset)) {
                throw new IpayApiException("rsaCheck failure:rsaParams=" + params);
            }
        }
    ...
    public static String checkSignAndDecrypt(Map<String, String> params, String ipayPublicKey,
                                             String cusPrivateKey, boolean isCheckSign,
                                             boolean isDecrypt, String signType) throws IpayApiException {
        String charset = params.get("charset");
        String bizContent = params.get("biz_content");
        if (isCheckSign) {
            if (!rsaCheckV2(params, ipayPublicKey, charset,signType)) {
                throw new IpayApiException("rsaCheck failure:rsaParams=" + params);
            }
        }
     ...
     * @throws IpayApiException 
     */
    public static String encryptAndSign(String bizContent, String ipayPublicKey,
                                        String cusPrivateKey, String charset, boolean isEncrypt,
                                        boolean isSign) throws IpayApiException {
        StringBuilder sb = new StringBuilder();
        if (StringUtils.isEmpty(charset)) {
            charset = IpayConstants.CHARSET_GBK;
        }
        sb.append("<?xml version=\"1.0\" encoding=\"" + charset + "\"?>");
        if (isEncrypt) {// 加密
            sb.append("<ipay>");
            String encrypted = rsaEncrypt(bizContent, ipayPublicKey, charset);
    ...
    public static String encryptAndSign(String bizContent, String ipayPublicKey,
                                        String cusPrivateKey, String charset, boolean isEncrypt,
                                        boolean isSign,String signType) throws IpayApiException {
        StringBuilder sb = new StringBuilder();
        if (StringUtils.isEmpty(charset)) {
            charset = IpayConstants.CHARSET_GBK;
        }
    ...
    public static String rsaEncrypt(String content, String publicKey,
                                    String charset) throws IpayApiException {
        try {
            PublicKey pubKey = getPublicKeyFromX509(IpayConstants.SIGN_TYPE_RSA,
                new ByteArrayInputStream(publicKey.getBytes()));
            Cipher cipher = Cipher.getInstance(IpayConstants.SIGN_TYPE_RSA);
            ...
            throw new IpayApiException("EncryptContent = " + content + ",charset = " + charset,
                e);
        }
    }
    ...
    public static String rsaDecrypt(String content, String privateKey,
        ...
        try {
            ...
            throw new IpayApiException("EncodeContent = " + content + ",charset = " + charset, e);
        }
    }
