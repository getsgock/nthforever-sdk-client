...
public class IpayLogger {
    ...
    public static void setNeedEnableLogger(boolean needEnableLogger) {
        IpayLogger.needEnableLogger = needEnableLogger;
    }
    ...
    private static void _logCommError(Exception e, HttpURLConnection conn, String url,
        ...
        String sdkName = IpayConstants.SDK_VERSION;
        String urlStr = null;
        String rspCode = "";
        if (conn != null) {
            try {
     ...
     * 发生特别错误时记录完整错误现场
     */
    public static void logErrorScene(Map<String, Object> rt, IpayResponse tRsp,
                                     String appSecret) {
        if (!needEnableLogger) {
            return;
        }
        ...
        appendLog((IpayHashMap) rt.get("protocalMustParams"), sb);
        sb.append("^_^");
        sb.append("ProtocalOptParams:");
        appendLog((IpayHashMap) rt.get("protocalOptParams"), sb);
        sb.append("^_^");
        sb.append("ApplicationParams:");
        appendLog((IpayHashMap) rt.get("textParams"), sb);
        sb.append("^_^");
        sb.append("Body:");
     ...
     * 发生特别错误时记录完整错误现场
     */
    public static void logBizSummary(Map<String, Object> rt, IpayResponse tRsp,
    ...
    private static void appendLog(IpayHashMap map, StringBuilder sb) {
        boolean first = true;
