 ...
 * 
 * @author jiehua
 * @version $Id: IpayEncrypt.java, v 0.1 2016-3-28 下午5:14:12 jiehua Exp $
 */
public class IpayEncrypt {
    ...
    public static String encryptContent(String content, String encryptType, String encryptKey,
        ...
        if (AES_ALG.equals(encryptType)) {
            ...
            throw new IpayApiException("当前不支持该算法类型：encrypeType=" + encryptType);
        }
    ...
    private static String aesEncrypt(String content, String aesKey, String charset)
        ...
        try {
            ...
            throw new IpayApiException("AES加密失败：Aescontent = " + content + "; charset = "
                                         + charset, e);
        }
    ...
    private static String aesDecrypt(String content, String key, String charset)
        ...
        try {
            ...
            throw new IpayApiException("AES解密失败：Aescontent = " + content + "; charset = "
                                         + charset, e);
        }
    }
