...
import com.ipay.api.common.internal.mapping.ApiListField;
import com.ipay.api.common.internal.util.IpayLogger;
...
public class JSONWriter {
    ...
    private void model(Object object) {
        ...
        try {
            ...
            IpayLogger.logBizError(e1);
        } catch (IllegalAccessException e2) {
            IpayLogger.logBizError(e2);
        } catch (IllegalArgumentException e3) {
            IpayLogger.logBizError(e3);
        } catch (InvocationTargetException e4) {
            IpayLogger.logBizError(e4);
        }
        add("}");
    }
    ...
    private void date(Date date) {
        if (this.format == null) {
            this.format = new SimpleDateFormat(IpayConstants.DATE_TIME_FORMAT);
            this.format.setTimeZone(TimeZone.getTimeZone(IpayConstants.DATE_TIMEZONE));
        }
        add("\"");
